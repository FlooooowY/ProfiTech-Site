...
## Шаг 10: Создание таблиц в базе данных
...
## Шаг 13: Установка PM2 (менеджер процессов)
...
## Шаг 15: Настройка SSL (Let's Encrypt)
...
## Шаг 17: Загрузка каталога товаров
...
## Шаг 19: Создание swap файла (рекомендуется)
